/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 4067d8ce68ae13e2b9287492005ae99e)
// Runtime types generated with workerd@1.20260310.1 2025-03-25 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
  ...
  interface DevEnv {
    ...
    WORKER_SELF_REFERENCE: Fetcher /* doom-index-dev */;
  }
  interface Env {
    VIEWER_KV: KVNamespace;
    NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
    ...
    ADMIN_SECRET: string;
    ARDRIVE_TURBO_SECRET_KEY: string;
    WORKER_SELF_REFERENCE: Fetcher /* doom-index-dev */ | Service<typeof import("./src/worker").default>;
  }
}
