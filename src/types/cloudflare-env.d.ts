/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env-interface CloudflareEnv src/types/cloudflare-env.d.ts` (hash: b51d00e449557d8b54b9663eb3b00ecb)
// Runtime types generated with workerd@1.20260312.1 2025-03-25 enable_weak_ref,global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		LOG_LEVEL: string;
		IMAGE_MODEL: string;
		NEXT_PUBLIC_GENERATION_INTERVAL_MS: string;
		NEXT_PRIVATE_DEBUG_CACHE: string;
		NEXT_PUBLIC_ENABLE_LEVA: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARWEAVE_GATEWAY_BASE_URL" | "NODE_ENV" | "NEXTJS_ENV" | "NEXT_PUBLIC_BASE_URL" | "LOG_LEVEL" | "IMAGE_MODEL" | "NEXT_PUBLIC_GENERATION_INTERVAL_MS" | "NEXT_PRIVATE_DEBUG_CACHE" | "NEXT_PUBLIC_ENABLE_LEVA" | "RUNWARE_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "TAVILY_API_KEY" | "COINGECKO_API_KEY" | "SLACK_WEBHOOK_URL" | "CACHE_PURGE_API_TOKEN" | "CACHE_PURGE_ZONE_ID" | "ADMIN_SECRET" | "ARDRIVE_TURBO_SECRET_KEY">> {}
}
