/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/types/worker-configuration.d.ts --env-interface CloudflareBindings` (hash: cfb578ec61b1fad052ff635f9f827637)
// Runtime types generated with workerd@1.20251118.0 2025-03-25 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "NEXTJS_ENV" | "NEXT_PUBLIC_BASE_URL" | "LOG_LEVEL" | "IMAGE_MODEL" | "NEXT_PRIVATE_DEBUG_CACHE" | "OPENAI_API_KEY" | "RUNWARE_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "TAVILY_API_KEY" | "COINMARKETCAP_API_KEY">> {}
}
