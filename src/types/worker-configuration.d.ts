/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/types/worker-configuration.d.ts --env-interface CloudflareBindings` (hash: 4777d30c3da5df5f77e53416661342e9)
// Runtime types generated with workerd@1.20251105.0 2024-09-23 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("../../workers/cron");
    }
    interface Env {
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROVIDER_API_KEY">> {}
}
