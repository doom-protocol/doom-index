/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/types/worker-configuration.d.ts --env-interface CloudflareBindings` (hash: d8357eeac00aa47023fec9da9decff34)
...
declare namespace Cloudflare {
  interface Env {
    ...
    R2_BUCKET: R2Bucket;
    WORKER_SELF_REFERENCE: Fetcher /* doom-index */;
    ASSETS: Fetcher;
  }
}
