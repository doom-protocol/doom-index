...
- Never read secret env files during normal work. Do not open or inspect `.env*`, legacy Wrangler `*.vars`, `.env.keys`, or other secret-bearing local config unless the user explicitly asks for that file/value.
