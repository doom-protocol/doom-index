...
describe("painting-context-classification", () => {
  ...
  it("selects composition and palette based on climate/archetype/event", () => {
    const event = { k: "rally" as const, i: 3 };
    ...
    expect(pickComposition("despair", "unknown", { k: "collapse", i: 3 })).toBe("storm-battlefield");
    ...
    expect(pickPalette("transition", "unknown", { k: "collapse", i: 1 })).toBe("ivory-marble");
  });
